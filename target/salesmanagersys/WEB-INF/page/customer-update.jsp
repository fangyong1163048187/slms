...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/customer-update.css">
    <script src="${pageContext.request.contextPath}/js/jquery-3.2.1-jquery.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/popper.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/customer-update.js"></script>
</head>
<body>
...
<form  class="form">
    ...
    <div class="form-group input-group mb-3" style="width:20%" id="div_name">
        ...
        <input type="text" name="number" class="form-control" id="number" placeholder="输入编号" value="${customer.customernumber}" readonly="readonly">
    </div>
    <span class="tip" id="number_tip"></span>
    <%--姓名--%>
    <div class="form-group input-group mb-3" style="width:20%" id="div_name">
        <div class="input-group-prepend">
            <label for="name"><span class="input-group-text">客户姓名:</span></label>
        </div>
        <input type="text" name="name" class="form-control" id="name" placeholder="输入姓名" value="${customer.customername}">
    </div>
    ...
    <div class="form-group input-group mb-3" style="width:20%">
        ...
        <input type="text" name="linkman" class="form-control" id="linkman" placeholder="联系人" value="${customer.linkman}">
    </div>
    ...
    <div class="form-group input-group mb-3" style="width:20%">
        ...
        <input type="text" name="linkphone" class="form-control" id="linkphone" placeholder="输入联系电话" value="${customer.linkphone}">
    </div>
    ...
    <div class="form-group input-group mb-3" style="width:20%">
        ...
        <input type="text" name="linkaddress" class="form-control" id="linkaddress" placeholder="输入联系地址" value="${customer.linkaddress}">
    </div>
    <span class="tip" id="linkaddress_tip"></span>
        <%--id--%>
    <input type="text" name="customerid" value="${customer.id}" style="display: none">
    <%--提交--%>
